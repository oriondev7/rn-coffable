...
import { COLORS, FONT_SIZE, IconName, PaymentMode, ScreenName } from '../../constants'
import { GradientBGIcon, PaymentFooter, PaymentMethod, PopUpAnimation } from '../../components'
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.paymentOptionsContainer}>
          <TouchableOpacity onPress={() => setPaymentMode(PaymentMode.creditCard)}>
            <View style={[styles.creditCardContainer, {
              borderColor: paymentMode === PaymentMode.creditCard
                ? COLORS.primaryOrangeHex
                : COLORS.primaryGreyHex
            }]}>
              <Text style={styles.creditCardTitle}>{PaymentMode.creditCard}</Text>
                ...
                >
                  ...
                  <View style={styles.creditCardRow}>
                    <View style={styles.creditCardNameContainer}>
                      ...
                      <Text style={styles.creditCardNameTitle}>Carl Johnson</Text>
                    </View>
