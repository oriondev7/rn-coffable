...
import { CartItem, EmptyListAnimation, HeaderBar, PaymentFooter } from '../../components'
        ...
        <View style={[styles.scrollViewInnerContainer, {
            ...
            {cartList.length === 0 
              ...
              : <View style={styles.listItemContainer}>
                {cartList.map((data: any) => 
                  <TouchableOpacity
                    key={data.id}
                    onPress={() => navigation.push(ScreenName.details, {
                      index: data.index, 
                      id: data.id, 
                      type: data.type 
                    })}
          ...
          {cartList.length !== 0
            ? <PaymentFooter
                ...
                title='Pay'
                onPress={() => navigation.navigate(ScreenName.payment, { total: cartPrice })}
              />
            : <></>
          }
        </View>
