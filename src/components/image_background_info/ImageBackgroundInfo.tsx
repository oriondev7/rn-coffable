            ...
            <View style={styles.footerRow}>
              ...
              <View style={styles.propertiesContainer}>
                <View style={styles.firstProperty}>
                  <CustomIcon
                    name={type === ItemType.bean ? IconName.bean : IconName.beans}
                    color={COLORS.primaryOrangeHex}
                    size={type === ItemType.bean ? FONT_SIZE.size_18 : FONT_SIZE.size_24}
                  />

                  <Text style={[
                    styles.firstPropertyBaseText, type === ItemType.bean 
                ...
                <View style={styles.firstProperty}>
                  <CustomIcon
                    name={type === ItemType.bean ? IconName.location : IconName.drop}
                    color={COLORS.primaryOrangeHex}
                    size={FONT_SIZE.size_16}
                  />
